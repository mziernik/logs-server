...
public class SyslogParser {
     ...
     * bytes are seen.
     */
    public TLog readEvent() throws IOException {
        int priority = 0;
        int c = read(false);
     ...
     */
    private TLog createEvent(int version, int priority, Calendar date, String hostname, byte[] appname, byte[] procId, byte[] msgId, byte[] structuredData, byte[] body) {
...
/*
     ...
     */
    private LogKind getEventPriorityBySyslog(int priority) {
        switch (priority % 8) {
            case 0:
            case 1:
            case 2:
                return LogKind.FATAL;
            case 3:
